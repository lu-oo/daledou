...
如果希望脱离本地挂机，部署到 Cloudflare Worker 云端定时运行，请查看根目录的 [CLOUDFLARE_DEPLOY.md](/Users/luzhanghua/owner/ai_project/daledou/CLOUDFLARE_DEPLOY.md)。
...
│   ├── .nvmrc               # 固定 Node.js 22.12.0
│   ├── .node-version        # 固定 Node.js 22.12.0
